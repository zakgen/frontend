...
export const mockBusiness: BusinessProfile = {
  ...
  contact_email: "contact@alwarda.ma",
  contact_phone: "+212 661 234 890",
  store_address: "123 Rue Zerktouni, Casablanca",
  shipping_policy:
  ...
  cod_confirmation_policy: "Chaque commande COD est confirmee par message WhatsApp avant l'envoi.",
  address_edit_policy: "L'adresse peut etre modifiee tant que le colis n'est pas expedie.",
  cancellation_policy: "Annulation gratuite avant expedition.",
...
export const mockProducts: Product[] = [
  {
    ...
    product_url: "https://alwarda.ma/products/djellaba-safran",
  ...
  },
  {
    ...
    product_url: "https://alwarda.ma/products/sac-cuir-sable",
    name: "Sac cuir sable",
    description: "Sac structure a finitions dorees, parfait for un usage quotidien chic.",
    category: "Sacs",
    price: 329,
    currency: "MAD",
  ...
  },
  {
    ...
    product_url: "https://alwarda.ma/products/kimono-rose-poudre",
  ...
  },
  {
    ...
    product_url: "https://alwarda.ma/products/serum-argan-eclat",
    name: "Serum argan eclat",
    description: "Serum nourrissant a l'huile d'argan for peaux seches et ternes.",
    category: "Beaute",
    price: 189,
    currency: "MAD",
...
export const mockMessages: ConversationMessage[] = [
  ...
  },
  {
    id: "msg-7",
    phone: "+212655444777",
    text: "Merci de confirmer votre commande pour le Redmi Note 13.",
    direction: "inbound",
    timestamp: new Date(now.getTime() - 1000 * 60 * 30).toISOString(),
    message_context: "order_confirmation",
    order_window_status: "ongoing",
    order_session_id: "ocs-1001",
    order_id: "ord-1001",
    order_external_id: "SHOP-1001",
  },
  {
    id: "msg-8",
    phone: "+212655444777",
  ...
  },
  {
    id: "msg-9",
    phone: "+212655444777",
    text: "Je veux modifier l'adresse de livraison.",
    direction: "inbound",
    timestamp: new Date(now.getTime() - 1000 * 60 * 26).toISOString(),
    message_context: "order_confirmation",
    order_window_status: "closed",
    order_session_id: "ocs-1001",
    order_id: "ord-1001",
    order_external_id: "SHOP-1001",
  },
